    ...
    <div class="content-body">
        ...
        <form method="post" class="fw-form" enctype="multipart/form-data">
            ...
            <div>
                ...
                <img id="view-image" src="<?php echo $settings['url_site'];?>/assets/img/<?php echo $post[0]['post_image'];?>" height="60"/>
                <input type="file" name="image" id="image" class="fw-form-group" value="<?php echo $settings['url_site']; ?>/assets/img/<?php echo $post[0]['post_image']; ?>"/>
            </div>
